  ...
  <div ref="root" v-if="manifest" >
    ...
    <div  class="card" draggable="true" @dragstart="onDrag">
      ...
      <div class="card-links" style="margin-top:auto;">
        <img src="https://juncture-digital.io/web-app/static/iiif.png" class="draggable-iiif" alt="IIIF manifest icon"
...
<script setup lang="ts">
  ...
  function onDrag(dragEvent:DragEvent) {
    ...
    let url = `https://iiif.juncture-digital.org/?manifest=${manifest.value.id}`
